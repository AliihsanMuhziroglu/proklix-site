...
export const uz: DictionaryEntry = {
  ...
  beforeAfter: {
    title: "Tarqoq kuzatuvdan nazoratli operatsiyaga o'ting",
    subtitle:
      "Proklix chatlarda yo'qoladigan arizalar, qo'lda tasdiqlashlar, tarqoq fayllar va tizimlar o'rtasidagi nusxalash ishini bitta oqimda birlashtiradi.",
    transformLabel: "Tartibsizlik → Nazorat",
    without: {
      title: "Proklix'siz",
      subtitle: "Ishlar chat, Excel va qo'lda kuzatuv orasida tarqaladi.",
      items: [
        "Arizalar Telegram chatlarida yo'qoladi",
        "Excel fayllari kech yoki to'liq yangilanmaydi",
        "Kim mas'ul ekanligi noaniq qoladi",
        "Tasdiqlashlar xabar va qo'lda kuzatiladi",
        "Fayllar, fotolar va izohlar turli joylarda qoladi",
        "Harakatlar tarixi va qaror zanjiri aniq ko'rinmaydi",
        "Ma'lumotlar tizimlar o'rtasida qo'lda nusxalanadi",
      ],
    },
    with: {
      title: "Proklix bilan",
      subtitle: "Har bir ariza, vazifa, tasdiqlash va natija kuzatiladigan bo'ladi.",
      items: [
        "Har bir arizaning statusi va mas'uli aniq",
        "Tasdiqlash bosqichlari tartib bilan va qayd etilgan holda ketadi",
        "Vazifalar Telegram orqali tegishli shaxsga boradi",
        "Fayl, foto va izohlar jarayonga bog'liq qoladi",
        "Kim, qachon, qanday qaror qilgani ko'rinadi",
        "Rahbariyat umumiy holatni bitta ekrandan kuzatadi",
        "Mavjud CRM, veb-sayt, ombor yoki Excel ma'lumotlari jarayonga ulanishi mumkin",
      ],
    },
    resultChips: [
      "Kamroq yo'qolgan ariza",
      "Aniqroq mas'uliyat",
      "Tezroq tasdiqlash",
      "Ko'rinadigan boshqaruv",
      "Toza tarix",
    ],
    callout: {
      title: "Eng katta farq: jarayon odamlar xotirasida emas, tizimda yashaydi.",
      description:
        "Ariza ochilganda kim mas'ul, qaysi bosqichda kutayotgani, qaysi fayllar qo'shilgani va qanday qarorlar qabul qilingani Proklix ichida qayd etilgan holda qoladi.",
      cta: "Jarayonimni tahlil qiling",
    },
  },
  sectors: {
  ...
  footer: {
    tagline:
      "Telegram orqali arizalar, tasdiqlashlar, vazifalar va mavjud tizim integratsiyalarini boshqarish platformasi.",
    location: "Toshkent / O'zbekiston",
    platformTitle: "Platforma",
    platformLinks: [
      { href: "#platform", label: "Platforma" },
      { href: "#integrations", label: "Integratsiyalar" },
      { href: "#processes", label: "Jarayonlar" },
      { href: "#pricing", label: "Paketlar" },
      { href: "#faq", label: "SSS" },
    ],
    solutionsTitle: "Yechimlar",
    solutionsLinks: [
      { href: "#use-cases", label: "Mijoz arizalari" },
      { href: "#processes", label: "Xarid tasdiqlash" },
      { href: "#integrations", label: "Ombor / zaxira" },
      { href: "#use-cases", label: "Maydon vazifalari" },
      { href: "#integrations", label: "Maxsus integratsiyalar" },
    ],
    contactTitle: "Aloqa",
    phone: "+998 77 257 43 54",
    telegramCta: "Telegram'dan yozing",
    telegramHelper: "Eng tez javob Telegram orqali beriladi.",
